...
class sfGuardUserTableMap extends TableMap {
	...
	{
    $this->addRelation('Bookmark', 'Bookmark', RelationMap::ONE_TO_MANY, array('id' => 'user_id', ), null, null);
    $this->addRelation('Vote', 'Vote', RelationMap::ONE_TO_MANY, array('id' => 'user_id', ), 'CASCADE', null);
