...
abstract class BasesfGuardUserForm extends BaseFormPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'vote_list'                     => new sfWidgetFormPropelChoice(array('multiple' => true, 'model' => 'Bookmark')),
    ));
    ...
    $this->setValidators(array(
      ...
      'vote_list'                     => new sfValidatorPropelChoice(array('multiple' => true, 'model' => 'Bookmark', 'required' => false)),
    ));
  ...
  public function saveVoteList($con = null)
  {
    ...
    $c = new Criteria();
    $c->add(VotePeer::USER_ID, $this->object->getPrimaryKey());
