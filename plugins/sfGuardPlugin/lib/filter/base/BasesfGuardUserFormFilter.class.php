...
abstract class BasesfGuardUserFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'vote_list'                     => new sfWidgetFormPropelChoice(array('model' => 'Bookmark', 'add_empty' => true)),
    ));
    ...
    $this->setValidators(array(
      ...
      'vote_list'                     => new sfValidatorPropelChoice(array('model' => 'Bookmark', 'required' => false)),
    ));
  ...
  public function addVoteListColumnCriteria(Criteria $criteria, $field, $values)
  {
    ...
    $criteria->addJoin(VotePeer::USER_ID, sfGuardUserPeer::ID);

    $value = array_pop($values);
    $criterion = $criteria->getNewCriterion(VotePeer::BOOKMARK_ID, $value);

    foreach ($values as $value)
    {
      $criterion->addOr($criteria->getNewCriterion(VotePeer::BOOKMARK_ID, $value));
    }
