...
class CategoryI18nTableMap extends TableMap {
	 ...
	 */
	const CLASS_NAME = 'lib.model.map.CategoryI18nTableMap';
	...
	public function initialize()
	{
	  // attributes
		...
		$this->setClassname('CategoryI18n');
		$this->setPackage('lib.model');
		$this->setUseIdGenerator(false);
		// columns
		$this->addForeignPrimaryKey('ID', 'Id', 'INTEGER' , 'category', 'ID', true, null, null);
		$this->addPrimaryKey('CULTURE', 'Culture', 'CHAR', true, 2, null);
	...
	{
    $this->addRelation('Category', 'Category', RelationMap::MANY_TO_ONE, array('id' => 'id', ), 'CASCADE', null);
	} // buildRelations()
