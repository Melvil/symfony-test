...
abstract class BaseCategoryI18nPeer {
	...
	const OM_CLASS = 'CategoryI18n';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'lib.model.CategoryI18n';

	/** the related TableMap class for this table */
	const TM_CLASS = 'CategoryI18nTableMap';
	...
	/**
	 * An identiy map to hold any loaded instances of CategoryI18n objects.
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		{
		  call_user_func($sf_hook, 'BaseCategoryI18nPeer', $criteria, $con);
		}
	 ...
	 *
	 * @param      CategoryI18n $value A CategoryI18n object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(CategoryI18n $obj, $key = null)
	{
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = CategoryI18nPeer::getOMClass(false);
	...
	public static function doSelectJoinCategory(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		CategoryI18nPeer::addSelectColumns($criteria);
		$startcol = (CategoryI18nPeer::NUM_COLUMNS - CategoryI18nPeer::NUM_LAZY_LOAD_COLUMNS);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		CategoryI18nPeer::addSelectColumns($criteria);
		$startcol2 = (CategoryI18nPeer::NUM_COLUMNS - CategoryI18nPeer::NUM_LAZY_LOAD_COLUMNS);
	...
	{
		return $withPrefix ? CategoryI18nPeer::CLASS_DEFAULT : CategoryI18nPeer::OM_CLASS;
	}
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseCategoryI18nPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseCategoryI18nPeer', $values, $con))
      {
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseCategoryI18nPeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseCategoryI18nPeer', $values, $con, $pk);
    }
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseCategoryI18nPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseCategoryI18nPeer', $values, $con))
      {
        return $sf_hook_retval;
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseCategoryI18nPeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseCategoryI18nPeer', $values, $con, $ret);
    }
	 ...
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			foreach ($values as $value) {
				...
				$criterion->addAnd($criteria->getNewCriterion(CategoryI18nPeer::CULTURE, $value[1]));
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BaseCategoryI18nPeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
