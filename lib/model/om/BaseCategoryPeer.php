...
abstract class BaseCategoryPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (self::ID, self::CREATED_AT, self::UPDATED_AT, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::CREATED_AT => 1, self::UPDATED_AT => 2, ),
	...
	{
		// invalidate objects in CategoryI18nPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$criteria->add(CategoryI18nPeer::ID, $obj->getId());
			$affectedRows += CategoryI18nPeer::doDelete($criteria, $con);

			// delete related BookmarkCategory objects
			$criteria = new Criteria(BookmarkCategoryPeer::DATABASE_NAME);
			
			$criteria->add(BookmarkCategoryPeer::CATEGORY_ID, $obj->getId());
	...
	/**
	 * Selects a collection of {@link Category} objects with a {@link CategoryI18n} translation populated.
	 *
	 * @param Criteria  $criteria
	...
	static public function doSelectWithI18n(Criteria $criteria, $culture = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
	  ...
	  $criteria->addJoin(CategoryPeer::ID, CategoryI18nPeer::ID, $join_behavior);
	  $criteria->add(CategoryI18nPeer::CULTURE, $culture);
	
	  foreach (sfMixer::getCallables('BaseCategory:doSelectJoin:doSelectJoin') as $sf_hook)
	  {
	    call_user_func($sf_hook, 'Category', $criteria, $con);
	  }
	  ...
	  $stmt = BasePeer::doSelect($criteria, $con);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
	      ...
	      CategoryPeer::addInstanceToPool($obj1, $key1);
			...
			$key2 = CategoryI18nPeer::getPrimaryKeyHashFromRow($row, $startcol);
			if ($key2 !== null) {
				$obj2 = CategoryI18nPeer::getInstanceFromPool($key2);
				if (!$obj2) {
					$cls = CategoryI18nPeer::getOMClass(false);
					$obj2 = new $cls();
					$obj2->hydrate($row, $startcol);
					CategoryI18nPeer::addInstanceToPool($obj2, $key2);
