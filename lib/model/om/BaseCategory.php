...
abstract class BaseCategory extends BaseObject  implements Persistent {
	...
	/**
	 * @var        array CategoryI18n[] Collection to store aggregation of CategoryI18n objects.
	 */
	protected $collCategoryI18ns;

	/**
	 * @var        Criteria The criteria used to select the current contents of collCategoryI18ns.
	 */
	...
	/**
	 * Clears out the collCategoryI18ns collection (array).
	 *
	...
	/**
	 * Initializes the collCategoryI18ns collection (array).
	 *
	 ...
	 * related CategoryI18ns from storage. If this Category is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	 * @return     array CategoryI18n[]
	 * @throws     PropelException
	 */
	...
	public function countCategoryI18ns(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		...
		if ($this->collCategoryI18ns === null) {
			if ($this->isNew()) {
				...
				$count = CategoryI18nPeer::doCount($criteria, false, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
	...
	public function addCategoryI18n(CategoryI18n $l)
	{
		...
		if (!in_array($l, $this->collCategoryI18ns, true)) { // only add it if the **same** object is not already associated
			array_push($this->collCategoryI18ns, $l);
			$l->setCategory($this);
		}
	}
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Category has previously been saved, it will retrieve
	 * related BookmarkCategorys from storage. If this Category is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collBookmarkCategorys === null) {
			if ($this->isNew()) {
			   $this->collBookmarkCategorys = array();
				...
				$criteria->add(BookmarkCategoryPeer::CATEGORY_ID, $this->id);
	 ...
	 */
	public function getBookmarkCategorysJoinBookmark($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(CategoryPeer::DATABASE_NAME);
		}
		...
		if ($this->collBookmarkCategorys === null) {
			if ($this->isNew()) {
				...
				$this->collBookmarkCategorys = BookmarkCategoryPeer::doSelectJoinBookmark($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	...
	/**
	 * Sets the "title" value of the current {@link CategoryI18n}.
	 *
	 * @return Category
	 */
	...
	public function getCurrentCategoryI18n($culture = null)
	{
	  ...
	  {
	    $object = $this->isNew() ? null : CategoryI18nPeer::retrieveByPK($this->getPrimaryKey(), $culture);
	    if ($object)
	    {
	      $this->setCategoryI18nForCulture($object, $culture);
	    }
	    else
	    {
	 ...
	 */
	public function setCategoryI18nForCulture(CategoryI18n $object, $culture)
	{
