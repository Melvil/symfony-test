...
abstract class BaseVotePeer {
	...
	const USER_ID = 'vote.USER_ID';

	/** the column name for the BOOKMARK_ID field */
	const BOOKMARK_ID = 'vote.BOOKMARK_ID';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('UserId', 'BookmarkId', 'Vote', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('userId', 'bookmarkId', 'vote', ),
		BasePeer::TYPE_COLNAME => array (self::USER_ID, self::BOOKMARK_ID, self::VOTE, ),
		BasePeer::TYPE_FIELDNAME => array ('user_id', 'bookmark_id', 'vote', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('UserId' => 0, 'BookmarkId' => 1, 'Vote' => 2, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('userId' => 0, 'bookmarkId' => 1, 'vote' => 2, ),
		BasePeer::TYPE_COLNAME => array (self::USER_ID => 0, self::BOOKMARK_ID => 1, self::VOTE => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('user_id' => 0, 'bookmark_id' => 1, 'vote' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	{
		$criteria->addSelectColumn(VotePeer::USER_ID);
		$criteria->addSelectColumn(VotePeer::BOOKMARK_ID);
		$criteria->addSelectColumn(VotePeer::VOTE);
	}
	...
	public static function addInstanceToPool(Vote $obj, $key = null)
	{
		if (Propel::isInstancePoolingEnabled()) {
			if ($key === null) {
				$key = serialize(array((string) $obj->getUserId(), (string) $obj->getBookmarkId()));
			} // if key === null
	...
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof Vote) {
				$key = serialize(array((string) $value->getUserId(), (string) $value->getBookmarkId()));
	...
	public static function doCountJoinsfGuardUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(VotePeer::USER_ID, sfGuardUserPeer::ID, $join_behavior);
	...
	public static function doCountJoinBookmark(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(VotePeer::BOOKMARK_ID, BookmarkPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Vote objects pre-filled with their Bookmark objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of Vote objects.
	...
	public static function doSelectJoinBookmark(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Vote) to $obj2 (Bookmark)
				$obj2->addVote($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		BookmarkPeer::addSelectColumns($criteria);
		$startcol4 = $startcol3 + (BookmarkPeer::NUM_COLUMNS - BookmarkPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			$key3 = BookmarkPeer::getPrimaryKeyHashFromRow($row, $startcol3);
			if ($key3 !== null) {
				$obj3 = BookmarkPeer::getInstanceFromPool($key3);
				if (!$obj3) {
					...
					BookmarkPeer::addInstanceToPool($obj3, $key3);
				} // if obj3 loaded

				// Add the $obj1 (Vote) to the collection in $obj3 (Bookmark)
				$obj3->addVote($obj1);
			} // if joined row not null
	...
	public static function doSelectJoinAllExceptsfGuardUser(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = VotePeer::getInstanceFromPool($key1))) {
				...
				// Add the $obj1 (Vote) to the collection in $obj2 (Bookmark)
				$obj2->addVote($obj1);
	...
	/**
	 * Selects a collection of Vote objects pre-filled with all related objects except Bookmark.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    foreach (sfMixer::getCallables('BaseVotePeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseVotePeer', $values, $con))
      {
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(VotePeer::USER_ID);
			$selectCriteria->add(VotePeer::USER_ID, $criteria->remove(VotePeer::USER_ID), $comparison);

			$comparison = $criteria->getComparison(VotePeer::BOOKMARK_ID);
			$selectCriteria->add(VotePeer::BOOKMARK_ID, $criteria->remove(VotePeer::BOOKMARK_ID), $comparison);
	 ...
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			foreach ($values as $value) {
				$criterion = $criteria->getNewCriterion(VotePeer::USER_ID, $value[0]);
				$criterion->addAnd($criteria->getNewCriterion(VotePeer::BOOKMARK_ID, $value[1]));
				$criteria->addOr($criterion);
				// we can invalidate the cache for this single PK
				VotePeer::removeInstanceFromPool($value);
			}
		}
	 ...
	 * @return     Vote
	 */
	public static function retrieveByPK($user_id, $bookmark_id, PropelPDO $con = null) {
		$key = serialize(array((string) $user_id, (string) $bookmark_id));
 		if (null !== ($obj = VotePeer::getInstanceFromPool($key))) {
 			return $obj;
		}
		...
		$criteria->add(VotePeer::USER_ID, $user_id);
		$criteria->add(VotePeer::BOOKMARK_ID, $bookmark_id);
